...
const TeachPage = () => {
    ...
    const getAllTeachJobs = async () => {
        try {
            setLoading(true);
            const res = await api.get("/get-all-teach-jobs");
            if (res.data.success) {
    ...
    const filterOptions = [
        ...
        { name: "Online", icon: <Globe size={16} /> },
        { name: "Offline", icon: <Users size={16} /> },
        { name: "Repetitor", icon: <GraduationCap size={16} /> },
    ];
                ...
                <section className="teach-controls-section teach-glass-effect">
                    <div className="teach-search-bar-container">
                        ...
                        <input 
                            ...
                            placeholder="Sabaq yamasa repetitor izlew..." 
                            value={searchTerm}
